...
sourcesIndex["calendar_mirror"] = {"name":"","dirs":[{"name":"cal_machine","files":["evs.rs","retriever.rs"]}],"files":["cal_display.rs","cal_machine.rs","display.rs","err.rs","formatter.rs","gpio_in.rs","main.rs","new_type.rs","stm.rs","systemd1.rs"]};
...
sourcesIndex["dbus"] = {"name":"","dirs":[{"name":"arg","files":["array_impl.rs","basic_impl.rs","mod.rs","msgarg.rs","variantstruct_impl.rs"]},{"name":"tree","files":["factory.rs","leaves.rs","methodtype.rs","mod.rs","objectpath.rs","utils.rs"]}],"files":["connection.rs","lib.rs","message.rs","prop.rs","signalargs.rs","stdintf.rs","strings.rs","watch.rs"]};
sourcesIndex["dot"] = {"name":"","files":["lib.rs"]};
